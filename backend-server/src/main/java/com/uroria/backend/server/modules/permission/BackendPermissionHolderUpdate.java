...
public final class BackendPermissionHolderUpdate extends PulsarBridge {
    private final Logger logger;
    private final BackendPermissionManager permissionManager;
    BackendPermissionHolderUpdate(Logger logger, BackendPermissionManager permissionManager, PulsarClient pulsarClient) throws PulsarClientException {
        super(pulsarClient, "permissionholder:update", "PermissionModule", 100000);
        this.logger = logger;
    ...
    public void onReceive(Consumer<byte[]> consumer, Message<byte[]> message) throws PulsarClientException {
        ...
        CompletableFuture.runAsync(() -> {
            ...
            try {
                ...
                holder = (PermissionHolder) input.readObject();
                input.close();
                inputBuffer.close();
            ...
            this.permissionManager.updateHolder(holder);
        });
    }
}
